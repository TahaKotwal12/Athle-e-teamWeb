<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardMaster.Master" AutoEventWireup="true" CodeBehind="GroupChat.aspx.cs" Inherits="NGO_PROJ.GroupChat" %>
...
<asp:Label ID="lbluname" runat="server" Font-Bold="True" ForeColor="#004000"></asp:Label>
    <asp:Label ID="lblmsg" runat="server" Width="600px"></asp:Label>
    </td>
</tr>
<tr>
